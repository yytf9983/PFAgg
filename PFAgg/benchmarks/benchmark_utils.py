...
def benchmark(benchmark, init_scenario, dont_run=False, runs=[]):
    ...
    for nclients in nclientss:
        for dropout in dropouts:
            ...
            counter += 1
            if dont_run:
                print("run {}: dimension = {}, nclients = {}, dropout = {}".format(
                    counter, dimension, nclients, dropout))
                continue
            ...
            scenario = Scenario(dimension, inputsize, keysize, ceil(
                threshold*nclients), nclients, dropout)
    ...
    print("Finished. Successful tests: {}/{}".format(
