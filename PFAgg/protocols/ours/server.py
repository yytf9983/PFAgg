...
from protocols.buildingblocks.Harary import *
...
class Server(object):
    ...
    *delta*  : `int` --
    ...
    def __init__(self) -> None:
        ...
        # the server encryption key for JL (we use zero)
        self.key = ServerKey(Server.pp, mpz(0))
    ...
    def online_construct(self, allbshares, Yzeroshares=None):
        ...
        **Returns**: 
        ...
        if Yzeroshares:
            ...
            Yzero = Server.TJL.ShareCombine(
                Server.pp, Yzeroshares, self.threshold)
        else:
            Yzero = None
